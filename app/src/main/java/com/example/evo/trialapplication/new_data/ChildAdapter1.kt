...
import com.example.evo.trialapplication.interview.List1
import com.example.evo.trialapplication.interview.ChildAdapter

class ChildAdapter1(val newModel: MutableList<CheckList>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    companion object {
        ...
        init {
            ...
            binding.radioButton.setOnClickListener {
                ...
                totalPriceListener?.invoke(totalPrice, groupId, differ.currentList[position],
                    differ.currentList[position].itemId, differ.currentList[position].name
                )
                selectedListener?.invoke(differ.currentList)
